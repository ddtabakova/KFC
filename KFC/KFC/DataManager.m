...
+ (void)saveDefaultData {
    ...
    r1.hasOutdoor = [NSNumber numberWithBool:YES];
    ...
    r2.hasOutdoor = [NSNumber numberWithBool:YES];
    ...
    r3.hasOutdoor = [NSNumber numberWithBool:NO];
    ...
    r4.hasOutdoor = [NSNumber numberWithBool:YES];
    ...
    r1.hasOutdoor = [NSNumber numberWithBool:NO];
    ...
    r6.hasOutdoor = [NSNumber numberWithBool:NO];
    ...
    r7.hasOutdoor = [NSNumber numberWithBool:NO];
    ...
    r8.hasOutdoor = [NSNumber numberWithBool:NO];
    ...
    r9.hasOutdoor = [NSNumber numberWithBool:NO];
    ...
    r10.hasOutdoor = [NSNumber numberWithBool:NO];
    ...
    r11.hasOutdoor = [NSNumber numberWithBool:NO];
    ...
    r12.hasOutdoor = [NSNumber numberWithBool:NO];
    ...
    r13.hasOutdoor = [NSNumber numberWithBool:YES];
